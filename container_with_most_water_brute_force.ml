...
(*This solution is of O(n(n+1)/2) complexity, because it calculates the are of every possible container. You can find a O(n) solution in this repository under the name container_with_most_water_faster.ml *)
